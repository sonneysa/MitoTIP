    ...
    for sheet_name in list_tRNA: 
        ...
        for row in sheet_active.iter_rows('B3:' + end_letter + '3'):
            for cell in row:
                ...
                MitoMAP_path = sheet_active.cell(row = 12, column = cell.col_idx)
                MAMit_path = sheet_active.cell(row = 15, column = cell.col_idx)
                Pubmed_path = sheet_active.cell(row = 17, column = cell.col_idx)
...
if prepare_tRNA_alignment_insertion == 1: 
    ...
    wb.save(workbook_name + '_mod.xlsx')
